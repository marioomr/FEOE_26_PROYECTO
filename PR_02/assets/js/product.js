...
// ================================
// 4️⃣ Función actualizar mini-cart
// ================================
...
// ================================
// 5️⃣ Fetch JSON y cargar producto
// ================================
...
if (addToCartBtn) {
    ...
    addToCartBtn.addEventListener('click', () => {
        ...
        const selectedColor =
            document.querySelector('.color-btn.border-blue-500')?.dataset.color || 'Default';
...
// ================================
// 8️⃣ Cargar mini-cart al iniciar
// ================================
updateMiniCart();